\begin{tikzpicture}[thick,scale=1, every node/.style={scale=1}, >={Latex[length=1.5mm, width=1mm]}]
    ...
    \node at (8, 2.5) {$u(x,y=H) = u_0$};
    \draw[domain=0:2.6667, samples=100] plot[id=x] function{0.75*x};
    % \draw[domain=0:3, samples=100] plot[id=x] function{1+sqrt(1-x/3)};
    \draw[black, ->] (0, 0.3333) -- (0.4444,0.3333);
    \draw[black, ->] (0, 0.6667) -- (0.8889,0.6667);
    \draw[black, ->] (0, 1) -- (1.3333,1);
    \draw[black, ->] (0, 1.3333) -- (1.7778,1.3333);
    \draw[black, ->] (0, 1.6667) -- (2.2222,1.6667);
    \draw[black, ->] (0, 2) -- (2.6667,2);
